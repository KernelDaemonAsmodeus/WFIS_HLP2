"""modul zarzadzania prosta biblioteka ksiazek"""


class Ksiazka:
    """klasa Książka używana przez Biblioteke"""
    ...
    def info(self):
        """zwraca informacje o ksiazce"""
        print(f"Książka pod tytułem {self.tytul}, autorstwa {self.autor}.")

    def pepe_why(self):
        """Too few public methods (0/2)"""
        print("Too few public methods")
...
class Biblioteka:
    ...
    def wypozycz_ksiazke(self, tytul):
        """sprawdza czy jest dostepna w bibliotece wypozycza jesli tak"""
    ...
    def zwroc_ksiazke(self, tytul):
        """zmienia wypozyczona ksiazke na dostepna"""
        for ksiazka in self.lista_ksiazek:
            if ksiazka.Tytul == tytul:
